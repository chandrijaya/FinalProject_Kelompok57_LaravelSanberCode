...
@section('content')
{{-- Ini contoh konten dari template Bona. bebas mau dipakai atau nggak --}}
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card h-100">
            <div class="single-post post-style-1">
                ...
                <div class="blog-image"><img src={{ asset("/Bona/images/audrey-jackson-260657.jpg")}} alt="Blog Image"></div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card h-100">
            <div class="single-post post-style-1">
                ...
                <div class="blog-image"><img src={{ asset("/Bona/images/pexels-photo-370474.jpeg")}} alt="Blog Image"></div>
